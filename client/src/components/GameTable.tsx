...
export const GameTable = ({
  ...
  console.log("GameTable Turn Detection:", {
    ...
    isMyTurn,
    myPlayer: myPlayer
      ? { name: myPlayer.name, socketId: myPlayer.socketId }
      : null,
    canAct,
    isSpectating,
      ...
      >
        ...
        <div
          style={{
            ...
            boxShadow:
              "0 20px 60px rgba(0,0,0,0.5), inset 0 0 100px rgba(0,0,0,0.3)",
          }}
        >
          {/* Table Inner Border */}
          <div
          ...
          >
            <div
              style={{ color: "#ffd700", fontSize: "14px", fontWeight: "bold" }}
            >
              POT
            </div>
            <div
          ...
          {gameState.players.map((player, index) => {
            ...
            const isCurrentTurn =
              gameState.currentTurnSocketId === player.socketId;
                        ...
                        : !isMe && gameState.gameStarted
                          ? // Show card backs for other players who haven't folded
                            [1, 2].map((_, idx) => (
                              ...
                              >
                                <div style={{ color: "#fff", opacity: 0.3 }}>
                                  🂠
                                </div>
                              </div>
                            ))
                          ...
                          {turnTimer && turnTimer.playerId === player.id && (
                            <div
                              style={{
                                ...
                                fontWeight: "bold",
                                color:
                                  turnTimer.timeRemaining <= 10
                                    ? "#e74c3c"
                                    : isMe
                                      ? "#fff"
                                      : "#000",
                                animation:
                                  turnTimer.timeRemaining <= 5
                                    ? "pulse 1s infinite"
                                    : "none",
                              }}
                            >
